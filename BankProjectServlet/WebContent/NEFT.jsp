...
<tr><td>Beneficiary ID</td>  <td><select name="bef_list">
                 <option value="0">Beneficiary Name</option>
                 <%
                 try{
                	 DriverManager.registerDriver(new oracle.jdbc.driver.OracleDriver());
                	 Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","system");
                	 Statement st=con.createStatement();
                	 ResultSet rs=st.executeQuery("select distinct BENEFICIARY_short_name from hemaa.add_beneficiary");
                	 while(rs.next())
                	 {
                		 %>
...
<tr><td>IFSC Code for Distination Account</td><td><select name="ifsc">
                 ...
                 try{
                	 ...
                	 Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","system");
                	 Statement st=con.createStatement();
                	 ResultSet rs=st.executeQuery("select distinct IFSC_code from hemaa.add_beneficiary");
                	 while(rs.next())
                	 {
                		 %>
...
<tr><td>Destination Account No</td><td><select name="bef_AccNo">
                 ...
                 try{
                	 ...
                	 Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","system");
                	 Statement st=con.createStatement();
                	 ResultSet rs=st.executeQuery("select distinct ACCOUNT_NUMBER from hemaa.add_beneficiary");
                	 while(rs.next())
                	 {
                		 %>
...
<tr><td>Beneficiary Name</td> <td><select name="bef_Name">
                 ...
                 try{
                	 ...
                	 Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","system");
                	 Statement st=con.createStatement();
                	 ResultSet rs=st.executeQuery("select BENEFICIARY_NAME from hemaa.add_beneficiary");
                	 while(rs.next())
                	 {
                		 %>
